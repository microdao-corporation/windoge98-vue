...
<template>
  <div class="window">
    <div class="title-bar">
      <div class="title-bar-text">Welcome to Windoge98</div>
    ...
    <div class="window-body">
      ...
      <p>
        ...
        Internet Computer (IC), this token is a nod to the Windows 98 operating system
        many of us grew up on, blending the world of classic computing and 90's aesthetic
