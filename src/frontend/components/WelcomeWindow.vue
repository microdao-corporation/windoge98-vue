...
<template>
  <div style="padding: 10px">
    <WindowLogo />
    <p>
      Windoge 98 is a nostalgic take on memecoins, designed as an ICRC-1 token
      on the Internet Computer (IC), this token is a nod to the Windows 98
      operating system many of us grew up on, blending the world of classic
      computing and 90's aesthetic with state of the art blockchain technology.
    </p>
    <p>
    ...
    <p style="text-align: center; float: bottom">
      ...
      >
      |
      <a href="https://www.coingecko.com/en/coins/windoge98" target="_blank"
        >CoinGecko</a
      >
      |
